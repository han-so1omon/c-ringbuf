...
main(int argc, char **argv)
{
    ...
    pringbuf_t rb1 = ringbuf_new(RINGBUF_SIZE - 1);

    int test_num = 0;

    /*
     * N.B.: these tests check both the pringbuf_t interface *and* a
     * particular implementation. They are not black-box tests. If you
     * make changes to the pringbuf_t implementation, some of these
     * tests may break.
     */
    ...
    pringbuf_t rb2 = ringbuf_new(RINGBUF_SIZE - 1);
